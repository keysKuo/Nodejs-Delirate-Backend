            ...
            <Container className="mt-5 w-75">
                ...
                <Grid columns={2} relaxed="very">
                    ...
                    <Grid.Column>
                        ...
                        <p>
                            Connect with customers post-purchase, no matter where they bought your product. The Delirate
                            Shopping app allow customers to scan Delirate codes to
                            confirm authenticity and access content you provide.
                        </p>

                        <h2>Optimize your supply chain</h2>
                        <p>
                            Gain additional insights on your items at the batch or lot level, helping you identify
                            supply chain or other issues, diagnose their root cause, implement solutions, and improve
                            products with minimal disruption to your business.
                        </p>
                    </Grid.Column>
                </Grid>
                </Container>
